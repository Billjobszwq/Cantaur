...
MAIN_BRIDGE_GATE = str(Path.home() / ".openclaw/workspace/integration/claudecodex/live-link/scripts/main_bridge_gate.py")
BRIDGE_EXECUTOR = str(Path.home() / ".openclaw/workspace/integration/claudecodex/live-link/scripts/bridge_executor.py")
BRIDGE_TERMINATOR = str(Path.home() / ".openclaw/workspace/integration/claudecodex/live-link/scripts/bridge_terminator.py")
BRIDGE_TIMEOUT_WATCHER = str(Path.home() / ".openclaw/workspace/integration/claudecodex/live-link/scripts/bridge_timeout_watcher.py")
DEFAULT_GATE_CONFIG = str(Path.home() / ".openclaw/workspace/integration/claudecodex/live-link/config/main-bridge-gate.v1.json")
