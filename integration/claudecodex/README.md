...
本目录用于承载 OpenClaw 与 ClaudeCodex 的融合设计、协议草案、目录骨架与后续实施文档。

当前原则：
- 先做结构化设计，不直接改生产运行链路
- 先建立可升级的协作内核，不重写现有 OpenClaw 底座
- 先抽能力边界，再决定哪些模块需要真正开发

## 当前目录结构

- `OPENCLAW-CLAUDECODEX-INTEGRATION-BLUEPRINT.md`
  - 总体融合蓝图
- `OPENCLAW-CLAUDECODEX-MODULE-MAP.md`
  - ClaudeCodex 能力与 OpenClaw 宿主映射
- `OPENCLAW-CLAUDECODEX-ROADMAP.md`
  - 分阶段实施路线图
- `OPENCLAW-ORIGINAL-VS-INTEGRATED-MODULE-COMPARISON.md`
  - 原始 OpenClaw 与当前整合版的模块对照
- `NEXT-STAGE-EVOLUTION-ROADMAP.md`
  - 下一阶段演化建议路线
- `OPENCLAW-CLAUDECODEX-PHASE0-TODO.md`
  - Phase 0 契约层清单
- `GLOSSARY.md`
  - 统一术语表
