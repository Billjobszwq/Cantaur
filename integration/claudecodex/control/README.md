...
```bash
python3 ${OPENCLAW_HOME}/workspace/integration/claudecodex/control/scripts/coordinator_cli.py \
  plan \
  ${OPENCLAW_HOME}/workspace/integration/claudecodex/control/examples/report-intake.example.json
```
