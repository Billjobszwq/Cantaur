...
- `OPENCLAW-A2A-V1-DRAFT.md`
  - 协议说明草案
- `PROTOCOL-FIELD-DICTIONARY.md`
  - 字段字典
- `openclaw-a2a-v1.schema.json`
  - 第一版 JSON Schema
- `examples/`
  - 各消息类型示例
- `scripts/validate_openclaw_a2a.py`
  - 本地校验脚本

## 当前目标

把 `openclaw-a2a/v1` 从“概念文档”推进到“可以被本地验证的协议交付”。
...
- `${OPENCLAW_HOME}/workspace/memory/20-semantic/review-queue/`
- `${OPENCLAW_HOME}/workspace/memory/30-procedures/`
...
- `${OPENCLAW_HOME}/workspace/integration/claudecodex/runtime/live/`
...
```bash
python3 ${OPENCLAW_HOME}/workspace/integration/claudecodex/protocols/scripts/validate_openclaw_a2a.py \
...
```bash
python3 ${OPENCLAW_HOME}/workspace/integration/claudecodex/protocols/scripts/validate_openclaw_a2a.py \
  ${OPENCLAW_HOME}/workspace/integration/claudecodex/protocols/examples
```
