...
统一知识主根见：
- `${QYCLAW_HOME}/workspace/knowledge/README.md`
- `${QYCLAW_HOME}/workspace/KNOWLEDGE-SYSTEM-V2.md`

## 默认输出目录

```bash
${QYCLAW_HOME}/workspace/integration/qy_code/memory-fusion/output/<task_id>/
```

## 本地使用

```bash
python3 ${QYCLAW_HOME}/workspace/integration/qy_code/memory-fusion/scripts/memory_fusion_cli.py \
  summarize \
